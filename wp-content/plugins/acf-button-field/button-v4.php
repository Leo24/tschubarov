...
class acf_field_button extends acf_field
{
	...
	*/
	...
	{
		// Note: This public function can be removed if not used
	...
	*
	*  This filter is appied to the $value after it is loaded from the db and before it is passed back to the api public functions such as the_field
	*
	*  @type	filter
	*  @since	3.6
	*  @date	23/01/13
