            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo get_template_directory_uri().'/seo-client-reports/';?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo get_template_directory_uri().'/seo-client-reports/';?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo get_template_directory_uri().'/seo-client-reports/';?>dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo get_template_directory_uri().'/seo-client-reports/';?>index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                        <li><a href="<?php echo get_template_directory_uri().'/seo-client-reports/';?>index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li><a href="<?php echo get_template_directory_uri().'/seo-client-reports/';?>documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
