    ...
    <div class="two_cols clearfix">
        ...
        <div class="col block_order">
            ...
            <p class="p_2">
                ...
                <a id="website" href="<?php echo $full_url?>" target="_blank"><?php echo $full_url; ?></a>
            </p>
            <p class="p_3">
...
(function($, window, document) {
	$(function() {
        ...
        csv = '<?php echo rawurlencode("Url\r\n".$csv); ?>';
        
        
        csvData = 'data:application/csv;charset=utf-8,' + csv;
        
        //console.log(csv);
        
      	if (window.navigator.msSaveBlob) { // IE 10+
      		//alert('IE' + csv);
      		window.navigator.msSaveOrOpenBlob(new Blob([csv], {type: "text/plain;charset=utf-8;"}), "back_link_list.csv")
      	} 
      	else {
      ...
      $(".ico_download_cvs").on('click', function (event) {
          //event.preventDefault();
      	
          exportTableToCSV.apply(this, ['back_link_list.csv']);
...
<article class="block_download_cvs" id="block_download_cvs">
    <div class="content_center clearfix">
        <div class="block_download_cvs_left">
            <a href="#" class="ico_download_cvs">Download a .CSV or<br> copy the values from here</a>
        </div>
...
<?php if (!empty($registrations)) { $i=0; ?>
<section class="block_backlinks_list">
    <h2 style="margin-top: 100px;">Profiles Urls</h2>
    <table class="table">
        <tbody><tr>
            <th>&nbsp;</th>
            <th>#</th>
        ...
        <?php foreach($registrations as $profile): $i++; ?>
        <tr>
            <td>&nbsp;</td>
            <td><?php echo $i; ?></td>
            <td>
                <a href="<?php echo $profile['profile_url']; ?>" target="_blank"><?php echo $profile['profile_url']; ?></a>
            </td>
...
<div class="coupon bounceInUp" id="coupon">
  <span class="cclose">X</span>
  <input type="text" class="acode" value="<?php echo substr($fullName, 0, 2).$orderID; ?>" readonly="readonly" />
  <span class="bcinfo">You can use this coupon code by ordering <a href="https://uk.fiverr.com/youngceaser/manually-do-20-pr-10-seo-high-pr-backlinks?extras=1703136" target="_blank">our best SEO Gig</a>.<br />Leave feedback, order now and choose anything for free <a href="https://uk.fiverr.com/youngceaser" target="_blank">from here</a></span>
</div>
